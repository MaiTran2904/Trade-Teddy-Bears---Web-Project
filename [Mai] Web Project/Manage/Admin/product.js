...
function showProduct() {
    ...
    callAPI("product", "GET", null).then((res) => {
        ...
        for (i in users) {
            ...
            row += '<td> <img src="' + users[i].img + '" style="width:100px;height:100px"> </td>';
            row += '<td> <img src="' + users[i].img2 + '" style="width:100px;height:100px"> </td>';
            row += '<td> <img src="' + users[i].img3 + '" style="width:100px;height:100px"> </td>';
